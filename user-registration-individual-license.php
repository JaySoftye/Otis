...
<section class="main-content light-grey-bg">
  <div class="container-fluid user-registration individual">
    ...
    <div class="row">
      ...
      <h1 class="text-center margin-auto bold">Individual Subscription</h1>
      <h5><strong>Congratulations,</strong> your ed tech skills are about to skyrocket. Let's get started by collecting some information in order to create your Opd account.</h5>
    </div>
    </div>
        ...
        <form action="" method="post" class="registration-form">
          ...
          $(document).ready(function() {
            $("form.registration-form").on("submit",function(e) {
              ...
              window.location.replace("user-secure-checkout.php");
            });
          });
          </script>
