      ...
      <div class="col-md-3 session-chapter-container">
        ...
        <div id="session-chapter-mobile-menu">
          <ul id="menu-select" class="course-sessions-list">
            <li class="list-title">Sessions</li>
          </ul>
      ...
      <div class="col-md flow-player-container">
        ...
        <div class="row course-details-content">
          ...
          <div class="col-md-10 no-padding">
            ...
            <p class="course-description">The second installment in our Chromebooks Concentration Series walks you through the steps to plan and set-up Chromebooks in your classroom, while discussing behavior management techniques at every step. Then, we arm you with a plethora of apps and extensions that may be beneficial to your classroom such as Turn Off the Lights, Google Keep, and Google Cast. This is a session you won’t want to miss. See you there!</p>
          </div>
