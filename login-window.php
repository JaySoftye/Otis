  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content login-container">
      ...
      <section class="login-section login-card">
        ...
        <p class="text-center black-text"><a class="black-text" href="#reset-password-window" data-toggle="modal" data-dismiss="modal" aria-label="Close"><u>Forgot Password?</u></a> | <a class="black-text" href="pricing.php"><u>Not a member?</u></a></p>
        <p class="bold text-center no-margin">or Sign in with:</p>
      ...
      <section class="login-section login-card">
        <div class="login-form">
          <div class="main-login-form margin-bottom">
            <p class="thin-heading no-margin bold text-center">Have a group code?</p>
            <a href="user-registration-group-code.php">
              <button type="button" class="login">REGISTER HERE</button>
            </a>
          </div>
        </div>
      </section>
