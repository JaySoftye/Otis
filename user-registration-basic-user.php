...
<section class="main-content light-grey-bg">
  <div class="container-fluid user-registration basic">

    <?php include 'convince-your-admin.php';?>

    <div class="row">
      <div class="col user-registration">
      <h1 class="text-center margin-auto bold">Basic Plan</h1>
      <h5>Your basic membership includes access to select content on <a href="http://onlinepd.teq.com/" title="http://onlinepd.teq.com/" class="black-text"><u>onlinepd.teq.com</u></a> and access to <a class="black-text" href="/courses/category/type/1"><u>basic use videos</u></a>. To gain immediate access please complete the form below.</h5>
    </div>
    </div>
